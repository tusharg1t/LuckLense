...
//													   <Name,Rank>
					...
					if (true) {
						...
						int l_cnt = countOfCharFromLastTen(main_seq, 'L',10);
						int w_cnt = countOfCharFromLastTen(main_seq, 'W',10);
...
//							
						...
						if(ct_xp > t_xp && t_betters+ct_betters > 20) {
